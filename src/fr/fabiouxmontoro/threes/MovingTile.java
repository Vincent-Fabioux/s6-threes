...
{
	public final static int TILES_SPEED_X = TILES_SIZE_X / 5;		// Vitesse X des tuiles (pixels/frame)
	public final static int TILES_SPEED_Y = TILES_SIZE_Y / 5;		// Vitesse Y des tuiles (pixels/frame)
