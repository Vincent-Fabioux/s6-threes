...
public class Threes extends JFrame {
	...
	public final static int MAIN_BUTTONS_SIZE_X = WINDOW_SIZE_X; // Largeur des
																	// boutons
																	// principaux
	public final static int MAIN_BUTTONS_SIZE_Y = WINDOW_SIZE_X / 8; // Hauteur
																		// des
																		// boutons
																		// principaux
	public final static int MAIN_BUTTONS_POLICE_SIZE = WINDOW_SIZE_X / 10; // Taille
																			// de
																			// la
																			// police
																			// des
																			// boutons
																			// principaux
	public final static int SCORE_LABEL_POLICE_SIZE = WINDOW_SIZE_X / 20; // Taille
																			// de
																			// la
																			// police
																			// du
	...
	public final static int SWIPE_MIN_MOVE = 5; // Mouvement minimal de la
												...
												// compte
	public final static float SWIPE_MIN_SPEED = 20 / 1000; // Mouvement minimal
															// de la souris pour
															// être pris en
															// compte
		...
		if (!controlsFreeze) {
			...
			case -1 * TILES_NB_L: // Mouvement vers le haut
				for (int i = TILES_NB_L; i < TILES_NB; i++) {
					// On va verifier que le mouvement est possible pour au
					// moins une tuile et le realiser en montant les tuiles
			...
			case 1: // Mouvement vers la droite
				for (int i = TILES_NB - 1; i >= 0; i--) {
					// On vérifie que le mouvement est possible pour au moins
					// une tuile et on le réalise
